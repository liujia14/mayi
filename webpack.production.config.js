...
var extractCSS = new ExtractTextPlugin("./static/css/[name].min.css");
var extractLESS = new ExtractTextPlugin('./static/css/[name].min.css.less');
...
var config = {
  ...
  module:{
    loaders:[ //loader
      ...
      {test:/\.(png|jpg|gif|woff|ttf)$/,loader:'url-loader?limit=30000&name=./static/images/[name][hash].[ext]'}
    ]
  },
  resolve: {
    extensions: ['', '.js', '.jsx'],
