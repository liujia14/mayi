...
class SellerEdit extends React.Component {
            ...
            ajax({
              ...
              success : (data) => {
                if (data.success===true) {
                  ...
                  setTimeout(() => {window.location.href=`/platform/pageconfig/messageBoard.htm?nomineeCode=${getUrlParam('nomineeCode')}`},1500);
                }else{
                  message.error(data.errors);
                  this.setState({
                    loading:false,
    ...
    render() {
        ...
        return (
          <div className="body">
            <Bread breadList={[{text : "首页",link : "/platform/index.htm"},{text : prizeName,link : "/platform/pageconfig/awardsDetail.htm?prizeCode="+this.state.prizeCode},{text : this.state.isWo,link : "javascript:();"}]} />
                      ...
                      <Upload   showUploadList={false}
                              ...
                              >
                        {
                          this.state.url ?
                            ...
                            <Icon type="plus" className="avatar-uploader-trigger" style={{width:'120px',height:'90px'}}/>
